...
HEADERS += exercises/cubees/mainwidget.h\
        exercises/cubees/sensors.h

SOURCES += exercises/cubees/main.cpp \
        exercises/cubees/mainwidget.cpp \
        exercises/cubees/sensors.cpp
...
contains(MEEGO_EDITION,harmattan) {
    target.path = /opt/cubees/bin
    INSTALLS += target
}

OTHER_FILES += shaders/cubees/* \
