...
//    glBindFramebuffer(GL_DRAW_FRAMEBUFFER, 0);
    check_gl_error();
    colorTex = new Mesh::Texture("mipcolorMap", arraytex, GL_TEXTURE_2D_ARRAY);
    depthTex = new Mesh::Texture("mipdepthMap",depthtex, GL_TEXTURE_2D_ARRAY);
    check_gl_error();
}

int MipMapGenerator::enable(int layer)
{
...
int MipMapGenerator::enableUniqueTarget()
{
    glBindFramebuffer(GL_DRAW_FRAMEBUFFER, fbo);
...
Mesh::Texture * MipMapGenerator::getDepthTexture()
{
    return depthTex;
}
